                    ...
                    <div className="space-y-6">
                        ...
                        <div className="p-6 rounded-2xl bg-gray-900/50 border border-gray-800/50">
                            ...
                            <div className="flex gap-3">
                                {[{ label: "Instagram", url: "https://www.instagram.com/zakylkhr_?igsh=MWc1cGF0bTBlbGljaA==" }, { label: "GitHub", url: "https://github.com/jeki101108" }, { label: "LinkedIn", url: "https://www.linkedin.com/in/muhammad-zaky-alkhaer-ahmad-8295a7426?utm_source=share_via&utm_content=profile&utm_medium=member_android" }].map((social) => (
                                    <a
                                        key={social.label}
                                        href={social.url}
                                        target="_blank"
